            ...
            <div class="payslip-container">
                ...
                <div class="earnings">
                    ...
                    <table>
                        ...
                        <tbody>
                            <tr>
                                <td>Base Pay</td>
                                <td>$<?php echo number_format($payslip_data['base_pay'], 2); ?></td>
                            </tr>
                            <tr>
                                <td>Overtime Pay</td>
                            ...
                            <tr>
                                ...
                                <td>$<?php echo number_format($payslip_data['night_differential'], 2); ?></td>
                            </tr>
                            <tr>
                                <td>Incentives</td>
                                <td>$<?php echo number_format($payslip_data['incentives'], 2); ?></td>
                            </tr>
                            <tr>
                                <td>Bonuses</td>
                                <td>$<?php echo number_format($payslip_data['bonuses'], 2); ?></td>
                            </tr>
                            <tr>
                                <td>Allowances</td>
                                <td>$<?php echo number_format($payslip_data['allowances'], 2); ?></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
                ...
                <div class="summary">
                    <div class="summary-item">
                        <span>Gross Pay:</span>
                        <span>$<?php echo number_format($payslip_data['gross_pay'], 2); ?></span>
                    </div>
                    <div class="summary-item">
                        <span>Total Deductions:</span>
                        <span>$<?php echo number_format($payslip_data['total_deductions'], 2); ?></span>
                    </div>
                    <div class="summary-item net-pay">
                        <span>Net Pay:</span>
                        <span>$<?php echo number_format($payslip_data['net_pay'], 2); ?></span>
                    </div>
                </div>
